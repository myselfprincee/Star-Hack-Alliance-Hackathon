...
let quizArr = [
    ...
    },
    {
        ...
        options: ['Olympus Mons', 'Mauna Kea', 'Mount Everest', 'Vesuvius'],
    ...
    },
    {
        ...
        options: ['Apollo 11', 'Apollo 13', 'Gemini 8', 'Voyager 1'],
    ...
    },
    {
        ...
        options: ['Voyager 1', 'New Horizons', 'Cassini', 'Galileo'],
    ...
    },
    {
        ...
        options: ['Messenger', 'Mariner 10', 'Voyager 2', 'Pioneer 10'],
    ...
    },
    {
        ...
        options: ['Triton', 'Miranda', 'Proteus', 'Nereid'],
    ...
    },
    {
        ...
        options: ['New Horizons', 'Voyager 1', 'Cassini', 'Galileo'],
        correctAnswer: 'New Horizons'
    },
    {
    ...
    },
    {
        ...
        options: ['Luna 1', 'Explorer 1', 'Sputnik 1', 'Luna 2'],
    ...
    },
    {
        ...
        options: ['Singularity', 'Event Horizon', 'Black Hole', 'Neutron Star'],
    ...
    },
    {
        ...
        options: ['Galaxy', 'Solar System', 'Universe', 'Nebula'],
    ...
    },
    {
        ...
        options: ['Big Bang', 'Red Shift', 'Cosmic Inflation', 'Dark Energy'],
    ...
    },
    {
        ...
        options: ['Kepler-22b', 'Kepler-186f', 'Proxima Centauri b', 'TRAPPIST-1e'],
    ...
    },
    {
        ...
        options: ['Solar Probe Plus', 'Parker Solar Probe', 'SOHO', 'STEREO'],
    ...
    },
    {
        ...
        options: ['Hubble Space Telescope', 'James Webb Space Telescope', 'TESS', 'Kepler'],
        correctAnswer: 'TESS'
    },
    {
        question: 'What is the name of the most massive neutron star discovered as of 2023?',
        options: ['PSR J0348+0432', 'PSR J0740+6620', 'Cassiopeia A', 'Vela Pulsar'],
        correctAnswer: 'PSR J0740+6620'
    },
    {
        question: 'Which galaxy is on a collision course with the Milky Way?',
        options: ['Andromeda Galaxy', 'Triangulum Galaxy', 'Whirlpool Galaxy', 'Black Eye Galaxy'],
    ...
    },
    {
        ...
        options: ['Juno', 'Galileo', 'JUICE (JUpiter ICy moons Explorer)', 'Cassini'],
    ...
    },
    {
        ...
        options: ['Voyager 1', 'Rosetta', 'New Horizons', 'Cassini'],
    ...
    },
    {
        ...
        options: ['Oumuamua', 'Borisov', 'Halley\'s Comet', 'Shoemaker-Levy 9'],
    ...
    {
        question: 'What is the name of the theory that describes the early development of the Universe?',
        options: ['Big Bang Theory', 'Steady State Theory', 'Pulsating Universe Theory', 'Quantum Fluctuation Model'],
        correctAnswer: 'Big Bang Theory'
    },
    {
        question: 'Which of the following exoplanets is located in the habitable zone of its star?',
        options: ['Kepler-452b', 'Kepler-22b', 'Proxima Centauri b', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'What is the primary method used to detect exoplanets?',
        options: ['Transit Photometry', 'Direct Imaging', 'Astrometry', 'Radial Velocity'],
    ...
    },
    {
        ...
        options: ['Hubble Space Telescope', 'Chandra X-ray Observatory', 'Euclid', 'Spitzer Space Telescope'],
        correctAnswer: 'Euclid'
    },
    {
        question: 'What is the term for a supermassive black hole at the center of a galaxy?',
        options: ['Quasar', 'Pulsar', 'Blazar', 'Seyfert Galaxy'],
    ...
    },
    {
        ...
        options: ['Solar Eclipse', 'Lunar Eclipse', 'Meteor Shower', 'Aurora'],
    ...
    },
    {
        ...
        options: ['Event Horizon', 'Photon Sphere', 'Ergosphere', 'Accretion Disk'],
        correctAnswer: 'Event Horizon'
    },
    {
    ...
    },
    {
        ...
        options: ['Olympus Mons', 'Mount Everest', 'Mauna Loa', 'Krakatoa'],
        correctAnswer: 'Olympus Mons'
    },
    {
        question: 'Which of the following is a dwarf planet?',
        options: ['Europa', 'Pluto', 'Mars', 'Neptune'],
        correctAnswer: 'Pluto'
    },
    {
        question: 'What phenomenon explains the acceleration of the universe\'s expansion?',
        options: ['Dark Energy', 'Dark Matter', 'Black Holes', 'The Big Bang'],
        correctAnswer: 'Dark Energy'
    },
    {
    ...
    },
    {
        ...
        options: ['Exoplanet', 'Rogue Planet', 'Dwarf Planet', 'Gas Giant'],
    ...
    },
    {
        ...
        options: ['Andromeda Galaxy', 'Triangulum Galaxy', 'Magellanic Clouds', 'Whirlpool Galaxy'],
        correctAnswer: 'Andromeda Galaxy'
    },
    {
    ...
    },
    {
        ...
        options: ['Supernova', 'Black Hole Formation', 'Neutron Star Formation', 'Pulsar Formation'],
    ...
    },
    {
        ...
        options: ['Viking 1', 'Pathfinder', 'Curiosity', 'Perseverance'],
    ...
    },
    {
        ...
        options: ['Halley\'s Comet', 'Comet Hale-Bopp', 'Comet Hyakutake', 'Comet Encke'],
    ...
    },
    {
        ...
        options: ['Galactic Collision', 'Starburst', 'Black Hole Merger', 'Supernova'],
    ...
    },
    {
        ...
        options: ['Black Hole', 'Neutron Star', 'White Dwarf', 'Pulsar'],
    ...
    },
    {
        ...
        options: ['Transit Method', 'Radar Imaging', 'Spectroscopy', 'Pulsar Timing'],
    ...
    },
    {
        ...
        options: ['Kuiper Belt', 'Oort Cloud', 'Asteroid Belt', 'Scattered Disc'],
    ...
    },
    {
        ...
        options: ['Rosetta', 'Philae', 'Voyager 1', 'Cassini'],
        correctAnswer: 'Philae'
    },
    {
        question: 'Which of the following is a characteristic feature of a pulsar?',
        options: ['Rapid Rotation', 'High Temperature', 'Strong Magnetic Field', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'What is the name of the theory that describes the early development of the Universe?',
        options: ['Big Bang Theory', 'Steady State Theory', 'Pulsating Universe Theory', 'Quantum Fluctuation Theory'],
        correctAnswer: 'Big Bang Theory'
    },
    {
    ...
    },
    {
        ...
        options: ['Nuclear Fusion', 'Stellar Nucleosynthesis', 'Accretion', 'Star Formation'],
        correctAnswer: 'Star Formation'
    },
    {
    ...
    },
    {
        ...
        options: ['Milky Way', 'Andromeda Galaxy', 'Triangulum Galaxy', 'Magellanic Clouds'],
        correctAnswer: 'Andromeda Galaxy'
    },
    {
        question: 'What phenomenon is thought to be the driving force behind the expansion of the universe?',
        options: ['Dark Energy', 'Dark Matter', 'Black Holes', 'Supernovae'],
        correctAnswer: 'Dark Energy'
    },
    {
        question: 'What is the name of the first known interstellar object to pass through our solar system?',
        options: ['Oumuamua', 'Borisov', 'Halley\'s Comet', 'Eris'],
        correctAnswer: 'Oumuamua'
    },
    {
    ...
    },
    {
        ...
        options: ['Pluto', 'Eris', 'Ultima Thule (Arrokoth)', 'Sedna'],
    ...
    },
    {
        ...
        options: ['Zenith', 'Nadir', 'Horizon', 'Apex'],
        correctAnswer: 'Zenith'
    },
    {
        question: 'Which space mission was the first to land a rover on Mars?',
    ...
    },
    {
        ...
        options: ['Supernova', 'Neutron Star', 'Black Hole', 'White Dwarf'],
    ...
    },
    {
        ...
        options: ['Luna 2', 'Apollo 11', 'Sputnik 1', 'Voyager 1'],
    ...
    },
    {
        ...
        options: ['Syzygy', 'Eclipse', 'Equinox', 'Solstice'],
    ...
    },
    {
        ...
        options: ['Comet', 'Asteroid', 'Meteoroid', 'Exoplanet'],
    ...
    },
    {
        ...
        options: ['Eclipse', 'Transit', 'Opposition', 'Conjunction'],
        correctAnswer: 'Transit'
    },
    {
        question: 'What is the name of the largest volcano in the solar system, located on Mars?',
        options: ['Olympus Mons', 'Mauna Loa', 'Mount Everest', 'Krakatoa'],
        correctAnswer: 'Olympus Mons'
    },
    {
        question: 'What is the term for the cloud of gas and dust that surrounds the nucleus of a comet?',
        options: ['Asteroid Belt', 'Kuiper Belt', 'Coma', 'Nebula'],
        correctAnswer: 'Coma'
    },
    {
        question: 'What is the name of the mission that aims to capture the first photograph of a black hole’s event horizon?',
        options: ['Voyager', 'Hubble Space Telescope', 'Event Horizon Telescope', 'James Webb Space Telescope'],
    ...
    },
    {
        ...
        options: ['Atom', 'Molecule', 'Particle', 'Quark'],
        correctAnswer: 'Atom'
    },
    {
        ...
        options: ['Fusion', 'Fission', 'Nucleosynthesis', 'Photodisintegration'],
    ...
    },
    {
        ...
        options: ['Half-Life', 'Decay Period', 'Radiation Time', 'Half-Time'],
    ...
    },
    {
        ...
        options: ['Astrology', 'Astronomy', 'Cosmology', 'Geology'],
    ...
    },
    {
      ...
      },
      {
        ...
        options: ['Astrophysics', 'Cosmology', 'Astronomy', 'Astrobiology'],
      ...
      },
      {
        ...
        options: ['Galileo', 'Juno', 'Pioneer 10', 'Voyager 1'],
        correctAnswer: 'Pioneer 10'
      },
      {
        question: 'What is the name of the largest impact crater on Earth?',
        options: ['Barringer Crater', 'Chicxulub Crater', 'Vredefort Crater', 'Sudbury Basin'],
      ...
      },
      {
        ...
        options: ['Blue Moon', 'Supermoon', 'Harvest Moon', 'Blood Moon'],
      ...
      },
      {
        ...
        options: ['Viking 1', 'Mariner 4', 'Pathfinder', 'Curiosity'],
      ...
      },
      {
        ...
        options: ['Solar Flare', 'Transit', 'Eclipse', 'Occultation'],
        correctAnswer: 'Transit'
      },
      {
        question: 'What is the name of the first animal to orbit the Earth?',
        options: ['Albert the monkey', 'Félicette the cat', 'Laika the dog', 'Ham the chimpanzee'],
      ...
      },
      {
        ...
        options: ['Kuiper Belt', 'Oort Cloud', 'Asteroid Belt', 'Scattered Disk'],
      ...
      },
      {
        ...
        options: ['Luna 2', 'Apollo 11', 'Sputnik 1', 'Viking 1'],
        correctAnswer: 'Luna 2'
      },
      {
        question: 'What is the name of the process by which a star maintains its energy output by converting hydrogen into helium?',
        options: ['Nuclear Fusion', 'Nuclear Fission', 'Chemical Reaction', 'Gravitational Contraction'],
      ...
      },
      {
        ...
        options: ['Luna 9', 'Apollo 11', 'Surveyor 1', 'Lunar Orbiter 1'],
      ...
      },
      {
        ...
        options: ['Big Bang', 'Cosmic Inflation', 'Dark Energy', 'Hubble\'s Law'],
        correctAnswer: 'Dark Energy'
      },
      {
        question: 'What is the name of the largest known star in the universe?',
        options: ['Betelgeuse', 'VY Canis Majoris', 'Upsilon Andromedae', 'Sirius'],
        correctAnswer: 'VY Canis Majoris'
    },
    {
        question: 'What phenomenon is theorized to occur when a massive star collapses under its own gravity at the end of its life cycle?',
        options: ['Supernova', 'Black Hole Formation', 'Neutron Star Formation', 'White Dwarf Formation'],
        correctAnswer: 'Black Hole Formation'
    },
    {
    ...
    {
        question: 'Which of the following is a method used to detect exoplanets?',
        options: ['Pulsar Timing', 'Transit Photometry', 'Astrobiology', 'Celestial Navigation'],
        correctAnswer: 'Transit Photometry'
    },
    {
        question: 'What is the name of the region around a star where conditions might be right for life?',
        options: ['Goldilocks Zone', 'Habitable Zone', 'Frost Line', 'Roche Limit'],
        correctAnswer: 'Habitable Zone'
    },
    {
        question: 'Which of the following is a famous nebula visible from Earth?',
        options: ['Orion Nebula', 'Crab Nebula', 'Horsehead Nebula', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
    ...
    {
        question: 'Which of the following is not a type of galaxy?',
        options: ['Spiral', 'Elliptical', 'Irregular', 'Pentagonal'],
    ...
    },
    {
        ...
        options: ['Event Horizon Telescope', 'Hubble Space Telescope', 'James Webb Space Telescope', 'Chandra X-ray Observatory'],
        correctAnswer: 'Event Horizon Telescope'
    },
    {
        question: 'What is the term for the explosive death of a star?',
        options: ['Nova', 'Supernova', 'Hypernova', 'White Dwarf'],
        correctAnswer: 'Supernova'
    },
    {
    ...
    {
        question: 'What is the name of the telescope that is considered the successor to the Hubble Space Telescope?',
        options: ['Spitzer Space Telescope', 'James Webb Space Telescope', 'Kepler Space Telescope', 'Chandra X-ray Observatory'],
        correctAnswer: 'James Webb Space Telescope'
    },
    {
    ...
    },
    {
        ...
        options: ['Their emission of visible light', 'The bending of light around them', 'Their strong gravitational pull on nearby stars', 'The radio waves they emit'],
    ...
    },
    {
        ...
        options: ['Photon Sphere', 'Event Horizon', 'Accretion Disk', 'Singularity'],
        correctAnswer: 'Event Horizon'
    },
    {
        question: 'Which of the following is a potential sign of life on an exoplanet?',
        options: ['Methane in its atmosphere', 'Presence of water', 'Oxygen in its atmosphere', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
    ...
    {
        question: 'What is the term for the study of the universe and its contents outside of Earth’s atmosphere?',
        options: ['Astrobiology', 'Astrophysics', 'Astronomy', 'Cosmology'],
        correctAnswer: 'Astronomy'
    },
    {
        question: 'Which of the following is not a method used to detect exoplanets?',
        options: ['Radial Velocity', 'Transit Method', 'Direct Imaging', 'Spectral Analysis'],
    ...
    },
    {
        ...
        options: ['Ram pressure stripping', 'Tidal stripping', 'Galactic wind', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which space mission first detected the cosmic neutrino background?',
        options: ['IceCube', 'Super-Kamiokande', 'ANTARES', 'None of the above'],
    ...
    },
    {
        ...
        options: ['Firewall', 'Fuzzball', 'Planckian', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which of these is not a type of cosmic string?',
        options: ['Fundamental string', 'Cosmic superstring', 'Vorton', 'Planck string'],
    ...
    },
    {
        ...
        options: ['Roche lobe overflow', 'Bondi accretion', 'Eddington accretion', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which space mission first detected the cosmic X-ray background?',
        options: ['Uhuru', 'ROSAT', 'Chandra', 'XMM-Newton'],
        correctAnswer: 'Uhuru'
    },
    {
        question: 'What is the name of the theoretical particle that could explain the hierarchy problem in particle physics?',
        options: ['Supersymmetric particle', 'Kaluza-Klein particle', 'String theory particle', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which of these is not a type of galaxy cluster?',
        options: ['Poor cluster', 'Rich cluster', 'Fossil cluster', 'Quantum cluster'],
    ...
    },
    {
        ...
        options: ['AGN feedback', 'Quasar mode', 'Radio mode', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which space mission first detected the cosmic gamma-ray background?',
        options: ['SAS-2', 'CGRO', 'Fermi', 'INTEGRAL'],
        correctAnswer: 'SAS-2'
    },
    {
        question: 'What is the name of the theoretical object that could exist as an alternative to a black hole?',
        options: ['Gravastar', 'Boson star', 'Quark star', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which of these is not a type of primordial black hole?',
        options: ['Planck mass black hole', 'Asteroid mass black hole', 'Stellar mass black hole', 'Supermassive black hole'],
    ...
    },
    {
        ...
        options: ['Kuiper Belt', 'Oort Cloud', 'Scattered Disc', 'Asteroid Belt'],
        correctAnswer: 'Oort Cloud'
    },
    {
        question: 'Which space mission first detected the cosmic microwave background radiation?',
    ...
    },
    {
        ...
        options: ['Doppler Effect', 'Zeeman Effect', 'Stark Effect', 'Compton Effect'],
        correctAnswer: 'Doppler Effect'
    },
    {
        question: 'Which of the following is not a type of cosmic ray?',
        options: ['Protons', 'Neutrinos', 'Heavy Nuclei', 'Gamma Rays'],
    ...
    },
    {
        ...
        options: ['Nuclear Fission', 'Nuclear Fusion', 'Radioactive Decay', 'Pair Production'],
        correctAnswer: 'Nuclear Fusion'
    },
    {
        question: 'Which spacecraft holds the record for the fastest human-made object?',
        options: ['Voyager 1', 'New Horizons', 'Parker Solar Probe', 'Juno'],
        correctAnswer: 'Parker Solar Probe'
    },
    {
        question: 'What is the term for the theoretical form of matter that may exist in the core of neutron stars?',
        options: ['Degenerate Matter', 'Quark Matter', 'Dark Matter', 'Antimatter'],
    ...
    },
    {
        ...
        options: ['Quintessence', 'Dark Energy', 'Cosmic Inflation', 'Vacuum Energy'],
    ...
    },
    {
        ...
        options: ['Goldilocks Zone', 'Habitable Zone', 'Temperate Zone', 'Liquid Belt'],
        correctAnswer: 'Habitable Zone'
    },
    {
        question: 'Which of these is not a type of supernova?',
        options: ['Type Ia', 'Type II', 'Type Ib/c', 'Type IV'],
    ...
    },
    {
        ...
        options: ['Calabi-Yau Manifold', 'Einstein-Rosen Bridge', 'Minkowski Space', 'Euclidean Plane'],
    ...
    },
    {
        ...
        options: ['Hawking Radiation', 'Penrose Process', 'Frame Dragging', 'Gravitational Redshift'],
        correctAnswer: 'Hawking Radiation'
    },
    {
        question: 'Which of these is not a type of cosmic inflation theory?',
        options: ['Chaotic Inflation', 'Eternal Inflation', 'Slow-roll Inflation', 'Rapid Inflation'],
    ...
    },
    {
        ...
        options: ['Heliopause', 'Termination Shock', 'Bow Shock', 'Magnetopause'],
        correctAnswer: 'Heliopause'
    },
    {
    ...
    },
    {
        ...
        options: ['Wormholes', 'Quantum Tunnels', 'Cosmic Strings', 'Hyperspace Lanes'],
        correctAnswer: 'Wormholes'
    },
    {
        question: 'Which of these is not a proposed solution to the Fermi Paradox?',
        options: ['Great Filter', 'Zoo Hypothesis', 'Rare Earth Hypothesis', 'Infinite Universe Theory'],
    ...
    },
    {
        ...
        options: ['Failed Supernova', 'Direct Collapse', 'Quiet Implosion', 'Dark Nova'],
        correctAnswer: 'Failed Supernova'
    },
    {
        question: 'Which of these is not a proposed method for interstellar travel?',
        options: ['Alcubierre Drive', 'Light Sail', 'Nuclear Pulse Propulsion', 'Quantum Leap Drive'],
    ...
    },
    {
        ...
        options: ['Strange Matter', 'Quark-Gluon Plasma', 'Bose-Einstein Condensate', 'Superfluid'],
        correctAnswer: 'Strange Matter'
    },
    {
        question: 'Which space mission first detected the presence of water ice on Mercury?',
        options: ['MESSENGER', 'BepiColombo', 'Mariner 10', 'Arecibo Observatory'],
        correctAnswer: 'MESSENGER'
    },
    {
        question: 'What is the term for the theoretical process by which a rotating black hole might release energy?',
        options: ['Penrose Process', 'Blandford-Znajek Process', 'Kerr Effect', 'Frame Dragging'],
        correctAnswer: 'Penrose Process'
    },
    {
        question: 'Which of these is not a type of magnetar?',
        options: ['Soft Gamma Repeater', 'Anomalous X-ray Pulsar', 'Rotating Radio Transient', 'X-ray Dim Isolated Neutron Star'],
    ...
    },
    {
        ...
        options: ['Cosmic Magnification', 'Einstein Ring', 'Microlensing', 'Gravitational Amplification'],
    ...
    },
    {
        ...
        options: ['Quantum Fluctuation', 'Cosmic Inflation', 'Baryogenesis', 'Nucleosynthesis'],
        correctAnswer: 'Quantum Fluctuation'
    },
    {
        question: 'Which of these is not a proposed dark matter candidate?',
        options: ['WIMP', 'Axion', 'Neutralino', 'Positron'],
    ...
    },
    {
        ...
        options: ['Frame Dragging', 'Gravitomagnetic Effect', 'Lense-Thirring Precession', 'Geodetic Effect'],
    ...
    },
    {
        ...
        options: ['ARIEL', 'CHEOPS', 'PLATO', 'TESS'],
        correctAnswer: 'ARIEL'
    },
    {
        question: 'What is the term for the theoretical limit to how small a length can be?',
        options: ['Planck Length', 'String Length', 'Quantum Limit', 'Minimal Distance'],
        correctAnswer: 'Planck Length'
    },
    {
        question: 'Which of these is not a type of cosmic void?',
        options: ['Supervoid', 'Local Void', 'Boötes Void', 'Dark Void'],
    ...
    },
    {
        ...
        options: ['Vacuum Polarization', 'Pair Production', 'Quantum Fluctuation', 'Casimir Effect'],
        correctAnswer: 'Vacuum Polarization'
    },
    {
        question: 'Which of these is not a type of gravitational wave source?',
        options: ['Binary Black Hole Merger', 'Neutron Star Collision', 'Supernova Explosion', 'Planetary Orbit'],
    ...
    },
    {
        ...
        options: ['Majorana Fermion', 'Sterile Neutrino', 'Magnetic Monopole', 'Tachyon'],
        correctAnswer: 'Majorana Fermion'
    },
    {
        question: 'Which space mission first detected evidence of plate tectonics on Europa?',
        options: ['Galileo', 'Voyager 2', 'New Horizons', 'Juno'],
    ...
    },
    {
        ...
        options: ['Kappa Mechanism', 'Eddington Valve', 'Cepheid Pulsation', 'Stellar Oscillation'],
        correctAnswer: 'Kappa Mechanism'
    },
    {
        question: 'Which of these is not a proposed solution to the black hole information paradox?',
        options: ['Holographic Principle', 'Firewall', 'Complementarity', 'Dark Energy Emission'],
    ...
    },
    {
        ...
        options: ['Brane', 'Cosmic String', 'Domain Wall', 'Quantum Foam'],
        correctAnswer: 'Brane'
    },
    {
        question: 'Which space mission first detected the presence of molecular oxygen in the Martian atmosphere?',
        options: ['MAVEN', 'ExoMars Trace Gas Orbiter', 'Mars Reconnaissance Orbiter', 'Mars Express'],
    ...
    },
    {
        ...
        options: ['Quark Nova', 'Strangelet Cascade', 'Hadron Collapse', 'Neutron Drip'],
        correctAnswer: 'Quark Nova'
    },
    {
        question: 'Which of these is not a type of stellar pulsation?',
        options: ['RR Lyrae', 'Cepheid', 'Mira Variable', 'Wolf-Rayet'],
    ...
    },
    {
        ...
        options: ['Sunyaev-Zeldovich Effect', 'Sachs-Wolfe Effect', 'Silk Damping', 'Baryon Acoustic Oscillation'],
    ...
    },
    {
        ...
        options: ['Gravitational Wave Recoil', 'Galactic Ejection', 'Slingshot Effect', 'Cosmic Expulsion'],
    ...
    },
    {
        ...
        options: ['Apollo 11', 'Luna 16', "Chang'e 5", 'ARTEMIS'],
        correctAnswer: 'Apollo 11'
    },
    {
        ...
        options: ['WIMP Annihilation', 'Dark Decay', 'Shadow Interaction', 'Halo Emission'],
        correctAnswer: 'WIMP Annihilation'
    },
    {
        question: 'Which of these is not a type of cosmic ray detector?',
        options: ['Air Shower Array', 'Neutrino Telescope', 'Cherenkov Detector', 'Bose-Einstein Condenser'],
    ...
    },
    {
        ...
        options: ['Axion', 'Neutralino', 'Gravitino', 'Sterile Neutrino'],
        correctAnswer: 'Axion'
    },
    {
        question: 'Which space mission first detected evidence of subsurface lakes on Mars?',
        options: ['Mars Express', 'Mars Reconnaissance Orbiter', 'Mars Global Surveyor', 'ExoMars'],
        correctAnswer: 'Mars Express'
    },
    {
        ...
        options: ['Accretion-Induced Collapse', 'Chandrasekhar Transgression', 'Type Ia Progenitor', 'Degenerate Overflow'],
    ...
    },
    {
        ...
        options: ['Active Galactic Nuclei', 'Gamma-Ray Bursts', 'Neutron Star Mergers', 'Planetary Magnetic Fields'],
    ...
    },
    {
        ...
        options: ['Planet', 'Star', 'Asteroid', 'Galaxy'],
        correctAnswer: 'Asteroid'
    },
    {
    ...
    },
    {
        ...
        options: ['Planet', 'Moon', 'Asteroid', 'Star'],
        correctAnswer: 'Star'
    },
    {
    ...
    },
    {
        ...
        options: ['Revolution', 'Rotation', 'Orbit', 'Axis'],
        correctAnswer: 'Orbit'
    },
    {
    ...
    },
    {
        ...
        options: ['Challenger', 'Apollo', 'Soyuz', 'Gemini'],
        correctAnswer: 'Soyuz'
    },
    {
    ...
    },
    {
        ...
        options: ['Cosmic Redshift', 'Doppler Effect', 'Gravitational Lensing', 'Time Dilation'],
        correctAnswer: 'Cosmic Redshift'
    },
    {
        question: 'Which spacecraft first detected evidence of cryovolcanism on Enceladus?',
        options: ['Cassini', 'Voyager 2', 'New Horizons', 'Juno'],
        correctAnswer: 'Cassini'
    },
    {
        question: 'What is the term for the theoretical process by which a black hole might lose information?',
        options: ['Information Paradox', 'Hawking Radiation', 'Quantum Tunneling', 'Event Horizon Breach'],
        correctAnswer: 'Information Paradox'
    },
    {
        question: 'Which of these is not a proposed dark energy model?',
        options: ['Quintessence', 'Phantom Energy', 'Cosmological Constant', 'Dark Fluid'],
        correctAnswer: 'Dark Fluid'
    },
    {
        question: 'What is the name of the largest known structure in the universe?',
        options: ['Hercules-Corona Borealis Great Wall', 'Sloan Great Wall', 'Huge-LQG', 'Boötes Void'],
        correctAnswer: 'Hercules-Corona Borealis Great Wall'
    },
    {
        question: 'Which space telescope is designed to study the universe in infrared light?',
        options: ['James Webb Space Telescope', 'Hubble Space Telescope', 'Chandra X-ray Observatory', 'Fermi Gamma-ray Space Telescope'],
        correctAnswer: 'James Webb Space Telescope'
    },
    {
    ...
    },
    {
        ...
        options: ['Stratosphere', 'Mesosphere', 'Thermosphere', 'Kármán Line'],
    ...
    },
    {
        ...
        options: ['Galaxy', 'Solar System', 'Nebula', 'Constellation'],
        correctAnswer: 'Constellation'
    },
    {
        question: 'What is the name of the force that keeps planets in orbit around the Sun?',
        options: ['Magnetic Force', 'Centrifugal Force', 'Gravitational Force', 'Electric Force'],
        correctAnswer: 'Gravitational Force'
    },
    {
    ...
    },
    {
        ...
        options: ['Astrology', 'Astronomy', 'Cosmology', 'Astrophysics'],
        correctAnswer: 'Astronomy'
    },
    {
        question: 'What is the name of the galaxy closest to the Milky Way?',
        options: ['Andromeda', 'Triangulum', 'Centaurus A', 'Magellanic Clouds'],
    ...
    },
    {
        ...
        options: ['Quark-Gluon Plasma', 'Bose-Einstein Condensate', 'Degenerate Matter', 'Strange Matter'],
        correctAnswer: 'Strange Matter'
    },
    {
        question: 'Which space mission first detected gravitational waves from the merger of two neutron stars?',
        options: ['LIGO/Virgo', 'LISA Pathfinder', 'KAGRA', 'Einstein Telescope'],
    ...
    },
    {
        ...
        options: ['Sub-Chandrasekhar Detonation', 'Helium Flash', 'Carbon Deflagration', 'Electron Capture'],
    ...
    },
    {
        ...
        options: ['Type I Migration', 'Type II Migration', 'Type III Migration', 'Type IV Migration'],
    ...
    },
    {
        ...
        options: ['Kozai Mechanism', 'Milankovitch Cycles', 'Lidov-Kozai Mechanism', 'Resonant Perturbation'],
    ...
    },
    {
        ...
        options: ['Aphelion', 'Perihelion', 'Zenith', 'Nadir'],
        correctAnswer: 'Perihelion'
    },
    {
        question: 'What is the name of the space station that orbits Earth?',
        options: ['Mir', 'Skylab', 'International Space Station', 'Tiangong'],
    ...
    },
    {
        ...
        options: ['Curiosity', 'Opportunity', 'Spirit', 'Sojourner'],
    ...
    {
        question: 'What is the term for the alignment of three celestial bodies?',
        options: ['Conjunction', 'Opposition', 'Syzygy', 'Transit'],
        correctAnswer: 'Syzygy'
    },
    {
    ...
    {
        question: 'What is the name of the point where an object orbiting Earth is neither falling towards nor away from the planet?',
        options: ['Lagrange Point', 'Roche Limit', 'Schwarzschild Radius', 'Hill Sphere'],
        correctAnswer: 'Lagrange Point'
    },
    {
        question: 'Which space telescope is specifically designed to search for potentially habitable exoplanets?',
        options: ['Kepler', 'Hubble', 'TESS', 'Spitzer'],
        correctAnswer: 'TESS'
    },
    {
        question: 'What is the term for the theoretical tunnels through space-time that might allow faster-than-light travel?',
        options: ['Wormholes', 'Black Holes', 'White Holes', 'Einstein-Rosen Bridges'],
        correctAnswer: 'Wormholes'
    },
    {
        question: 'Which of these is not a type of cosmic ray?',
        options: ['Protons', 'Electrons', 'Heavy Nuclei', 'Photons'],
        correctAnswer: 'Photons'
    },
    {
        question: 'What is the name of the effect where light from a distant source is bent by the gravitational field of a massive object?',
        options: ['Gravitational Lensing', 'Refraction', 'Diffraction', 'Interference'],
        correctAnswer: 'Gravitational Lensing'
    },
    {
        question: 'Which of these is not a phase of stellar evolution for a Sun-like star?',
        options: ['Red Giant', 'White Dwarf', 'Neutron Star', 'Planetary Nebula'],
        correctAnswer: 'Neutron Star'
    },
    {
        question: 'What is the term for the theoretical limit to how much information can be stored in a given volume of space?',
    ...
    },
    {
        ...
        options: ['WIMPs', 'Axions', 'Neutrinos', 'All of the above'],
        correctAnswer: 'All of the above'
    },
    {
        question: 'Which spacecraft first detected the heliopause?',
    ...
    },
    {
        ...
        options: ['Seyfert nucleus', 'LINER', 'Quasar', 'Pulsar'],
        correctAnswer: 'Pulsar'
    },
    {
        question: 'What is the name of the largest known void in the universe?',
        options: ['Boötes Void', 'Giant Void', 'KBC Void', 'CMB Cold Spot'],
        correctAnswer: 'KBC Void'
    },
    {
        question: 'Which space telescope is designed to study dark energy and dark matter?',
        options: ['Euclid', 'WFIRST', 'JWST', 'LISA'],
        correctAnswer: 'Euclid'
    },
    {
    ...
    },
    {
        ...
        options: ['Variable star', 'Pulsar', 'Quasar', 'Blazar'],
        correctAnswer: 'Variable star'
    },
    {
        question: 'Which spacecraft was the first to orbit Mercury?',
        options: ['Mariner 10', 'MESSENGER', 'BepiColombo', 'None of the above'],
        correctAnswer: 'MESSENGER'
    },
    {
        question: 'What is the name of the largest asteroid in the asteroid belt?',
    ...
    },
    {
        ...
        options: ['Io', 'Europa', 'Titan', 'Triton'],
        correctAnswer: 'Titan'
    },
    {
    ...
    },
    {
        ...
        options: ['NASA', 'ESA', 'Soviet Space Program', 'JAXA'],
    ...
    },
    {
        ...
        options: ['Steady State Theory', 'Big Bang Theory', 'Inflation Theory', 'Multiverse Theory'],
        correctAnswer: 'Big Bang Theory'
    },
    {
        question: 'Which planet in our Solar System has the most volcanoes?',
        options: ['Earth', 'Mars', 'Venus', 'Io (a moon of Jupiter)'],
        correctAnswer: 'Venus'
    }
]
...
const uniqueQuestions = Array.from(new Set(quizArr.map(JSON.stringify))).map(JSON.parse);

console.log(uniqueQuestions.length);

// Convert the array to a JSON string
const uniqueQuestionsJSON = JSON.stringify(uniqueQuestions, null, 2);

// Write the JSON string to a file
fs.writeFile('uniqueQuestions.json', uniqueQuestionsJSON, 'utf8', (err) => {
  if (err) {
